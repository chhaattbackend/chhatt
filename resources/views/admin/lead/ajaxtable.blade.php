<div>
    ...
    @forelse ($leads as $item)
        @if ($item->response_status == 'Intend to Buy')
            @if (auth()->user()->role->name == 'Administrator' || auth()->user()->id == $item->created_by)
                ...
                <tr ondblclick="selectMultiple('{{ $item->id }}')" id="tablerow{{ $item->id }}">
                    ...
                    <td>
                        ...
                        @elseif ($item->visit_date==null)
                            ...
                            <span style="cursor: pointer" id="visit_date{{ $item->id }}"
                                onclick="openVisitModal('{{ $item->id }}')" data-toggle="modal"
                                data-target="#myModal" class="badge badge-pill badge-info">Date Not
                                Set</span><br>
                        ...
                        <span class="badge badge-pill badge-success status{{ $item->id }}">
                            @if ($item->response_status == null) New Lead @endif {{ $item->response_status }}
                        </span>
                    </td>
                    {{-- <td class="ani">
                    ...
                    <td class="tdname">
                        ...
                        @foreach ($phones as $item1)
                            <a href="https://api.whatsapp.com/send?phone={{ $item1 }}">{{ $item1 }}</a>
                            <br>
                        @endforeach
                    </td>
                    ...
                    <td> <b>Call Status</b> <br>
                        <select style="" onchange="changeCallStatus('{{ $item->id }}')"
                            id="callstatus{{ $item->id }}">
                        ...
                        <select onchange="changeResponseStatus('{{ $item->id }}')"
                            id="responsestatus{{ $item->id }}">
                ...
                <div class="col-sm-2">
                    ...
                    <td>
                        <a href="{{ route('leads.edit', $item->id) }}" class="float-left"><i
